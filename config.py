...
CREALITY_STATUS_ENABLED = _env_bool("CREALITY_STATUS_ENABLED", False)
CREALITY_STATUS_POLL_SECONDS = _env_float("CREALITY_STATUS_POLL_SECONDS", 5.0)
CREALITY_CONTROL_ENABLED = _env_bool("CREALITY_CONTROL_ENABLED", False)
CREALITY_CONTROL_TIMEOUT_SECONDS = _env_float("CREALITY_CONTROL_TIMEOUT_SECONDS", 5.0)

DASHBOARD_HOST = _env_string("DASHBOARD_HOST", "127.0.0.1")
DASHBOARD_PORT = _env_int("DASHBOARD_PORT", 8001)
